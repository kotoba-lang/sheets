...
if (web.kotobaArtifact.requiredCapabilities.length !== 0)
  throw new Error("sheets bounded-cells Web graph requested a capability");
if (web.instantiateKotoba().main() !== 42n) throw new Error("sheets Web main mismatch");
...
if (wasm.instance.exports.main() !== 42n) throw new Error("sheets Wasm main mismatch");

console.log("sheets: bounded cell-table Web/Wasm conformance passed");
